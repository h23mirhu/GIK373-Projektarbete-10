...
// JSON code for the average deforestation of pine trees in each region in Sweden written in the variable 'querySeDeforestationP'
const querySeDeforestationP = {
  "query": [
    {
      "code": "År",
      "selection": {
...
// JSON code for the average deforestation of spruce trees in each region in Sweden written in the variable 'querySeDeforestationS'
const querySeDeforestationS = {
  "query": [
    {
      "code": "År",
      "selection": {
...
// JSON code for the average deforestation of deciduous trees in each region in Sweden written in the variable 'querySeDeforestationD'
const querySeDeforestationD = {
  "query": [
    {
      "code": "År",
      "selection": {
...
// Request object with information from the dataset
// The request har the type 'POST'
// The content of the request is in the variable 'querySeDeforestationA'
const requestSeDeforestationA = new Request(urlSeDeforestation, {
    method: 'POST',
    body: JSON.stringify(querySeDeforestationA)
});

// The method fetch is used to preform the requestSeDeforestationA and convert it to JSON
// The function 'printSeForestAreaChartA' is sent in the last .then
fetch(requestSeDeforestationA)
    .then((responseSeDeforestationA) => responseSeDeforestationA.json())
    .then((dataSeTreesA) => {
...
// Request object with information from the dataset
// The request har the type 'POST'
// The content of the request is in the variable 'querySeDeforestationP'
const requestSeDeforestationP = new Request(urlSeDeforestation, {
    method: 'POST',
    body: JSON.stringify(querySeDeforestationP)
});

// The method fetch is used to preform the requestSeDeforestationS and convert it to JSON
// The function 'printSeForestAreaChartP' is sent in the last .then
fetch(requestSeDeforestationP)
    .then((responseSeDeforestationP) => responseSeDeforestationP.json())
    .then((dataSeTreesP) => {
        const { labels, data } = preparationSeTreesChart(dataSeTreesP.data);
        printSeDeforestationChart(
            'seDeforestationP',
            "Sweden’s Average Deforestation of Pine Trees in Each region (2000-2020)",
            labels,
            data
        );
    });
...
// Request object with information from the dataset
// The request har the type 'POST'
// The content of the request is in the variable 'querySeDeforestationS'
const requestSeDeforestationS = new Request(urlSeDeforestation, {
    method: 'POST',
    body: JSON.stringify(querySeDeforestationS)
});

// The method fetch is used to preform the requestSeDeforestationS and convert it to JSON
// The function 'printSeForestAreaChartS' is sent in the last .then
fetch(requestSeDeforestationS)
    .then((responseSeDeforestationS) => responseSeDeforestationS.json())
    .then((dataSeTreesS) => {
        const { labels, data } = preparationSeTreesChart(dataSeTreesS.data);
        printSeDeforestationChart(
            'seDeforestationS',
            "Sweden’s Average Deforestation of Spruce Trees in Each region (2000-2020)",
            labels,
            data
        );
    });
...
// Request object with information from the dataset
// The request har the type 'POST'
// The content of the request is in the variable 'querySeDeforestationD'
const requestSeDeforestationD = new Request(urlSeDeforestation, {
    method: 'POST',
    body: JSON.stringify(querySeDeforestationD)
});

// The method fetch is used to preform the requestSeDeforestationD and convert it to JSON
// The function 'printSeForestAreaChartD' is sent in the last .then
fetch(requestSeDeforestationD)
    .then((responseSeDeforestationD) => responseSeDeforestationD.json())
    .then((dataSeTreesD) => {
        const { labels, data } = preparationSeTreesChart(dataSeTreesD.data);
        printSeDeforestationChart(
            'seDeforestationD',
            "Sweden’s Average Deforestation of Deciduous Trees in Each region (2000-2020)",
            labels,
            data
        );
    });
